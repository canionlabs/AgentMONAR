...
#define BOARD_NAME                    "MONAR"        // Name of your product. Should match App Export request info.
#define BOARD_VENDOR                  "CanionLabs"        // Name of your company. Should match App Export request info.
#define BOARD_TEMPLATE_ID             "TMPL0000"

#define PRODUCT_WIFI_SSID             "monar"         // Name of the device, to be displayed during configuration. Should match export request info.
#define BOARD_CONFIG_AP_URL           "monar.cc"      // Config page will be available in a browser at 'http://our-product.cc/'
